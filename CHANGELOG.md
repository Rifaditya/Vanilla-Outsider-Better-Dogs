...
## [1.0.58+1.21.1] - 2026-08-16
### Fixed
- 🚨 **Resolved Startup Crash (Superclass Mixin Target Mismatch)**:
  - Removed illegal `@Inject(method = "doHurtTarget")` from `WolfMixin.java` which caused a fatal bootstrap `InvalidInjectionException` because `Wolf` does not declare `doHurtTarget` (it is inherited from `Mob.class`).
  ...
  - Supersedes yanked versions `1.0.53+1.21.1` through `1.0.57+1.21.1`.

## [1.0.57+1.21.1] - 2026-08-16 [YANKED / BROKEN ON STARTUP]
### Added
...
## [1.0.56+1.21.1] - 2026-08-16 [YANKED / BROKEN ON STARTUP]
### Added
...
## [1.0.55+1.21.1] - 2026-08-16 [YANKED / BROKEN ON STARTUP]
### Added
...
## [1.0.54+1.21.1] - 2026-08-16 [YANKED / BROKEN ON STARTUP]
### Added
...
## [1.0.53+1.21.1] - 2026-08-16 [YANKED / BROKEN ON STARTUP]
### Added
