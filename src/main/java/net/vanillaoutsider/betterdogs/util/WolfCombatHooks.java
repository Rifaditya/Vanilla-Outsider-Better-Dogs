...
public class WolfCombatHooks {
    ...
    public static boolean onActuallyHurt(Wolf wolf, DamageSource source, float amount) {
        ...
        // 0. SOCIAL CHANNEL BYPASS: If attacker is using Social AI on us, ALLOW
        // damage/trigger
     ...
     *         or null to pass to super.
     */
    public static Boolean wantsToAttack(Wolf wolf, LivingEntity target, LivingEntity owner) {
        if (!(wolf instanceof WolfExtensions ext))
            return null;

        // 0. RETALIATION OVERRIDE: If this is an authorized Retaliation vs the specific
        // target, ALLOW IT.
        ...
        // Baby wolves cannot attack adult pack members (can still target owner for
        // retaliation)
