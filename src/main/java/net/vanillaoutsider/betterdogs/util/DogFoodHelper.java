...
public class DogFoodHelper {
    ...
    public static boolean isEdibleDogFood(Level level, ItemStack stack) {
        ...
        return props != null && (props.canAlwaysEat() || props.nutrition() > 0);
    }
    ...
    public static float calculateHealAmount(ItemStack stack) {
        ...
        FoodProperties props = stack.get(DataComponents.FOOD);
        if (props != null) {
            return (float) props.nutrition() * 2.0F;
        }
        return 4.0F;
    }

    public static float calculateHealAmount(net.minecraft.world.entity.animal.wolf.Wolf wolf, ItemStack stack) {
