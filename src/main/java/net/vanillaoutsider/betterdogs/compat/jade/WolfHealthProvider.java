...
public enum WolfHealthProvider implements IEntityComponentProvider {
    ...
    public void appendTooltip(ITooltip tooltip, EntityAccessor accessor, IPluginConfig config) {
        if (accessor.getEntity() instanceof Wolf wolf) {
            ...
            net.minecraft.client.gui.Gui.HeartType heartType = wolf.isFullyFrozen() ? net.minecraft.client.gui.Gui.HeartType.FROZEN : net.minecraft.client.gui.Gui.HeartType.NORMAL;
