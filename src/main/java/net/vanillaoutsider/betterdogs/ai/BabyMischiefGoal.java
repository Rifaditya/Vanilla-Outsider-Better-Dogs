...
// IMPORTANT: Using Config, NOT GameRules for 1.21.11
// IMPORTANT: Using persistence extensions

/**
 * AI Goal: Aggressive baby randomly attacks a nearby entity (unprovoked
 * mischief).
...
public class BabyMischiefGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        // Use Config in 1.21.11
        double chance = BetterDogsConfig.Companion.get().getBabyMischiefChance();
