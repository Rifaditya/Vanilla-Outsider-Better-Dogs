...
public class BabyMischiefGoal extends Goal {
    ...
    public boolean canUse() {
        ...
        if (this.wolf instanceof WolfExtensions ext) {
            if (ext.betterdogs$isGuarding() || ext.betterdogs$getCalmTicks() > 0) {
                return false;
            }
        }
    ...
    public boolean canContinueToUse() {
        ...
        if (this.wolf instanceof WolfExtensions ext && ext.betterdogs$getCalmTicks() > 0) {
            return false;
        }
    ...
    public void tick() {
        ...
        if (this.wolf.distanceToSqr(this.target) <= 2.25) {
            if (this.wolf.getCommandSenderWorld() instanceof ServerLevel serverLevel) {
