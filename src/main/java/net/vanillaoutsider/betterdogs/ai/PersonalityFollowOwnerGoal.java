...
public class PersonalityFollowOwnerGoal extends FollowOwnerGoal {
    ...
    public PersonalityFollowOwnerGoal(Wolf wolf, double speedModifier, float minDistance, float maxDistance, boolean leavesAllowed) {
        super(wolf, speedModifier, minDistance, maxDistance, leavesAllowed);
        this.wolf = wolf;
