        ...
        if (distSqr <= 3.5) {
            ...
            if (this.fightTicks % 25 == 0) {
                ...
                if (level instanceof ServerLevel serverLevel) {
                    ...
                    serverLevel.playSound(null, this.wolf.getX(), this.wolf.getY(), this.wolf.getZ(), SoundEvents.WOLF_SHAKE, SoundSource.NEUTRAL, 0.6F, pitch);
                }
            }
        }
    }
