...
public class BetterDogsGameRules {
    ...
    public static void register() {
        ...
        BD_STORM_ANXIETY = registerBoolean("betterdogs:bd_storm_anxiety", BETTER_DOGS,
                config.getEnableStormAnxiety());
        BD_CREEPER_EVASION_ENABLED = registerBoolean("betterdogs:bd_creeper_evasion_enabled", BETTER_DOGS, true);
        BD_CLIFF_SAFETY = registerBoolean("betterdogs:bd_cliff_safety", BETTER_DOGS,
                config.getEnableCliffSafety());
        BD_FLEE_LOW_HEALTH = registerBoolean("betterdogs:bd_flee_low_health", BETTER_DOGS,
                config.getEnableFleeLowHealth());
        BD_DOGS_EAT_RAW_FOOD = registerBoolean("betterdogs:bd_dogs_eat_raw_food", BETTER_DOGS,
                config.getEnableDogsEatRawGroundFood());
        BD_DOGS_EAT_COOKED_FOOD = registerBoolean("betterdogs:bd_dogs_eat_cooked_food", BETTER_DOGS,
                config.getEnableDogsEatCookedGroundFood());
        BD_ENABLE_REFUSE_GROUND_FOOD = registerBoolean("betterdogs:bd_enable_refuse_ground_food", BETTER_DOGS,
                config.getEnableRefuseGroundFood());
        BD_REFUSE_GROUND_FOOD_CHANCE = registerInteger("betterdogs:bd_refuse_ground_food_chance", BETTER_DOGS,
                config.getRefuseGroundFoodChance());
        BD_FRIENDLY_FIRE = registerBoolean("betterdogs:bd_friendly_fire_protection", BETTER_DOGS,
                config.getEnableFriendlyFireProtection());
        BD_CREEPER_AWARENESS = registerBoolean("betterdogs:bd_creeper_awareness",
                BETTER_DOGS, BetterDogsConfig.get().creeperAwareness);
        
        BD_PACK_FLANKING_TACTICS = registerBoolean("betterdogs:bd_pack_flanking_tactics",
                BETTER_DOGS, BetterDogsConfig.get().enablePackFlankingTactics);
        BD_FLANKING_RAYCAST_CHECK = registerBoolean("betterdogs:bd_flanking_raycast_check",
                BETTER_DOGS, true);
        BD_DEBUGGING = registerBoolean("betterdogs:bd_debugging", BETTER_DOGS, false);
        BD_NEMESIS_SYSTEM = registerBoolean("betterdogs:bd_nemesis_system", BETTER_DOGS, true);
        BD_NEMESIS_DURATION_DAYS = registerInteger("betterdogs:bd_nemesis_duration_days", BETTER_DOGS, 3);
        ...
        // Aggressive
        BD_AGGRO_HEALTH = registerInteger("betterdogs:bd_aggressive_health", BETTER_DOGS,
                (int) config.getAggressiveHealthBonus());
        BD_AGGRO_SPEED_PCT = registerInteger("betterdogs:bd_aggro_speed_percent", BETTER_DOGS,
                (int) (config.getAggressiveSpeedModifier() * 100));
        BD_AGGRO_DMG_PCT = registerInteger("betterdogs:bd_aggro_dmg_percent", BETTER_DOGS,
                (int) (config.getAggressiveDamageModifier() * 100));
        BD_AGGRO_FLEE_CHANCE = registerInteger("betterdogs:bd_aggro_flee_chance", BETTER_DOGS,
                config.getAggressiveFleeChance());
        // Pacifist
        BD_PACI_HEALTH = registerInteger("betterdogs:bd_paci_health", BETTER_DOGS,
                (int) config.getPacifistHealthBonus());
        BD_PACI_SPEED_PCT = registerInteger("betterdogs:bd_paci_speed_percent", BETTER_DOGS,
                (int) (config.getPacifistSpeedModifier() * 100));
        BD_PACI_DMG_PCT = registerInteger("betterdogs:bd_paci_dmg_percent", BETTER_DOGS,
                (int) (config.getPacifistDamageModifier() * 100));
        BD_PACI_KNOCKBACK_PCT = registerInteger("betterdogs:bd_paci_knockback_percent", BETTER_DOGS,
                (int) (config.getPacifistKnockbackModifier() * 100));
        BD_PACI_FLEE_CHANCE = registerInteger("betterdogs:bd_paci_flee_chance", BETTER_DOGS,
                config.getPacifistFleeChance());
        // Normal
        BD_NORMAL_HEALTH = registerInteger("betterdogs:bd_normal_health", BETTER_DOGS,
                (int) config.getNormalHealthBonus());
        BD_NORMAL_SPEED_PCT = registerInteger("betterdogs:bd_normal_speed_percent", BETTER_DOGS,
                (int) (config.getNormalSpeedModifier() * 100));
        BD_NORMAL_DMG_PCT = registerInteger("betterdogs:bd_normal_dmg_percent", BETTER_DOGS,
                (int) (config.getNormalDamageModifier() * 100));
        BD_NORMAL_FLEE_CHANCE = registerInteger("betterdogs:bd_normal_flee_chance", BETTER_DOGS,
                config.getNormalFleeChance());



        BD_AGGRO_FOLLOW_START = registerInteger("betterdogs:bd_aggro_follow_start", BETTER_DOGS,
                (int) config.getAggressiveFollowStart());
        BD_AGGRO_CHASE_DIST = registerInteger("betterdogs:bd_aggro_chase_dist", BETTER_DOGS,
                (int) config.getAggressiveChaseDistance());
        BD_AGGRO_DETECT_RANGE = registerInteger("betterdogs:bd_aggro_detect_range", BETTER_DOGS,
                (int) config.getAggressiveDetectionRange());
        BD_PACI_FOLLOW_START = registerInteger("betterdogs:bd_paci_follow_start", BETTER_DOGS,
                (int) config.getPacifistFollowStart());
        BD_NORMAL_FOLLOW_START = registerInteger("betterdogs:bd_normal_follow_start", BETTER_DOGS,
                (int) config.getNormalFollowStart());

        // Misc Social
        BD_BABY_MISCHIEF_PERMILLE = registerInteger("betterdogs:bd_baby_mischief_permille", BETTER_DOGS,
                (int) (config.getBabyMischiefChance() * 10));
        BD_HOWL_CHANCE = registerInteger("betterdogs:bd_howl_chance", BETTER_DOGS, 10);
        BD_PACK_SPREAD = registerInteger("betterdogs:bd_pack_spread", BETTER_DOGS, 20);
        BD_GIFT_FEED_THRESHOLD = registerInteger("betterdogs:bd_gift_feed_threshold", BETTER_DOGS, config.getGiftFeedThreshold());
        BD_GIFT_INTERACTION_COOLDOWN = registerInteger("betterdogs:bd_gift_interaction_cooldown", BETTER_DOGS, config.getGiftInteractionCooldown());
        BD_DEMERIT_ACCIDENTAL_ATTACKS = registerBoolean("betterdogs:bd_demerit_accidental_attacks", BETTER_DOGS, config.getDemeritAccidentalAttacks());

        // Discipline
        BD_BLOOD_FEUD_PERCENT = registerInteger("betterdogs:bd_blood_feud_percent", BETTER_DOGS,
        ...
        BD_TERRITORIAL_RIVALRY = registerBoolean("betterdogs:bd_territorial_rivalry", BETTER_DOGS, true);
        // Territorial Matrix (v3.4.6)
        BD_TERR_AA_WAR = registerInteger("betterdogs:bd_territorial_matrix_aa_war", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixAAWar());
        BD_TERR_AA_MERGE = registerInteger("betterdogs:bd_territorial_matrix_aa_merge", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixAAMerge());
        BD_TERR_AN_WAR = registerInteger("betterdogs:bd_territorial_matrix_an_war", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixANWar());
        BD_TERR_AN_MERGE = registerInteger("betterdogs:bd_territorial_matrix_an_merge", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixANMerge());
        BD_TERR_AP_WAR = registerInteger("betterdogs:bd_territorial_matrix_ap_war", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixAPWar());
        BD_TERR_AP_MERGE = registerInteger("betterdogs:bd_territorial_matrix_ap_merge", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixAPMerge());
        BD_TERR_NN_WAR = registerInteger("betterdogs:bd_territorial_matrix_nn_war", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixNNWar());
        BD_TERR_NN_MERGE = registerInteger("betterdogs:bd_territorial_matrix_nn_merge", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixNNMerge());
        BD_TERR_NP_WAR = registerInteger("betterdogs:bd_territorial_matrix_np_war", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixNPWar());
        BD_TERR_NP_MERGE = registerInteger("betterdogs:bd_territorial_matrix_np_merge", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixNPMerge());
        BD_TERR_PP_WAR = registerInteger("betterdogs:bd_territorial_matrix_pp_war", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixPPWar());
        BD_TERR_PP_MERGE = registerInteger("betterdogs:bd_territorial_matrix_pp_merge", BETTER_DOGS,
                BetterDogsConfig.get().getTerrMatrixPPMerge());
        BD_TERRITORIAL_FATAL_CHANCE = registerInteger("betterdogs:bd_territorial_fatal_chance", BETTER_DOGS, 5);
        BD_TERRITORIAL_EXCLUSIVE_DISPUTES = registerBoolean("betterdogs:bd_territorial_exclusive_disputes",
                BETTER_DOGS, true);
        BD_WILD_PERSONALITY_BEHAVIOR = registerBoolean("betterdogs:bd_wild_personality_behavior",
                BETTER_DOGS, true);
        BD_TERRITORIAL_SEARCH_RADIUS = registerInteger("betterdogs:bd_territorial_search_radius", BETTER_DOGS,
                96);



        BD_BREED_SAME_CHANCE = registerInteger("betterdogs:bd_breed_same_chance", BETTER_DOGS,
                config.getBreedingSameParentChance());
        BD_BREED_SAME_OTHER_CHANCE = registerInteger("betterdogs:bd_breed_same_other_chance", BETTER_DOGS,
                config.getBreedingSameParentOtherChance());
        BD_BREED_MIXED_DOMINANT_CHANCE = registerInteger("betterdogs:bd_breed_mixed_dominant_chance",
                BETTER_DOGS, config.getBreedingMixedDominantChance());
        BD_BREED_MIXED_RECESSIVE_CHANCE = registerInteger("betterdogs:bd_breed_mixed_recessive_chance",
                BETTER_DOGS, config.getBreedingMixedRecessiveChance());
        BD_BREED_DILUTED_NORMAL_CHANCE = registerInteger("betterdogs:bd_breed_diluted_normal_chance",
                BETTER_DOGS, config.getBreedingDilutedNormalChance());
        BD_BREED_DILUTED_OTHER_CHANCE = registerInteger("betterdogs:bd_breed_diluted_other_chance",
                BETTER_DOGS, config.getBreedingDilutedOtherChance());
        // Litter Size (v3.4.0)
        BD_WOLF_LITTER_MAX_SIZE = registerInteger("betterdogs:bd_wolf_litter_max_size", BETTER_DOGS, 4);
        BD_WOLF_LITTER_EXTRA_CHANCE = registerInteger("betterdogs:bd_wolf_litter_extra_chance", BETTER_DOGS,
                20);



        BD_SPAWN_NORMAL_PERCENT = registerInteger("betterdogs:bd_spawn_normal_percent", BETTER_DOGS,
                config.spawnChanceNormal);
        BD_SPAWN_AGGRO_PERCENT = registerInteger("betterdogs:bd_spawn_aggro_percent", BETTER_DOGS,
                config.spawnChanceAggressive);
        BD_SPAWN_PACI_PERCENT = registerInteger("betterdogs:bd_spawn_paci_percent", BETTER_DOGS,
                config.spawnChancePacifist);
        BD_WOLF_PACK_CLUSTER_SIZE = registerInteger("betterdogs:bd_wolf_pack_cluster_size",
                BETTER_DOGS, 8);
        BD_WOLF_SPAWN_DENSITY_BOOST = registerInteger("betterdogs:bd_wolf_spawn_density_boost",
                BETTER_DOGS, 0);
        BD_WOLF_SPAWN_MULTIPLIER_PCT = registerInteger("betterdogs:bd_wolf_spawn_multiplier_percent",
                BETTER_DOGS, (int)(config.getWolfSpawnMultiplier() * 100));
        BD_WOLF_SPAWN_GROUP_MIN = registerInteger("betterdogs:bd_wolf_spawn_group_min",
                BETTER_DOGS, config.getSpawnGroupMin());
        BD_WOLF_SPAWN_GROUP_MAX = registerInteger("betterdogs:bd_wolf_spawn_group_max",
        ...
        // Pack Spread Scaling
        BD_TAMED_PACK_SPREAD_MULTIPLIER = registerInteger("betterdogs:bd_tamed_pack_spread_multiplier", BETTER_DOGS,
                config.getTamedPackSpreadMultiplier());
        BD_TAMED_PACK_SPREAD_MAX = registerInteger("betterdogs:bd_tamed_pack_spread_max", BETTER_DOGS,
                config.getTamedPackSpreadMax());
        BD_WILD_PACK_SPREAD_MULTIPLIER = registerInteger("betterdogs:bd_wild_pack_spread_multiplier", BETTER_DOGS,
                config.getWildPackSpreadMultiplier());
        BD_WILD_PACK_SPREAD_MAX = registerInteger("betterdogs:bd_wild_pack_spread_max", BETTER_DOGS,
