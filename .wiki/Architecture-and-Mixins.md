# Architecture & Mixins (Minecraft 1.21.1)
...
| :--- | :--- | :--- | :--- |
| `WolfEntityMixin` | `Wolf` | `initGoals`, `addAdditionalSaveData`, `readAdditionalSaveData`, `createAttributes` | Personality state, NBT persistence, `Attributes.SCALE` registration |
