# Vanilla Outsider: Better Dogs (Minecraft 1.20.1)
...
Welcome to the dedicated documentation for **Vanilla Outsider: Better Dogs** on **Minecraft 1.20.1** (Release `1.0.70+1.20.1`).

---

## 🎮 Gameplay Mechanics Matrix

Explore detailed guides tailored to Minecraft 1.20.1:
...
* [[Breeding, Genetics & Litter Sizes|Breeding-and-Genetics]] — Litters (1 to 4 puppies), inbreeding runt penalties, and visual scale genetics (70% - 145%) rendered via `WolfRendererMixin`.
...
* [[Developer Setup & Building|Developer-Setup-and-Building]] — Setup with Java 17, Gradle 9.3+, Loom 1.10.2, and `./gradlew build --no-daemon`.
* [[Architecture & Mixins|Architecture-and-Mixins]] — Package structure, 10 Mixin target points (including `WolfRendererMixin`), and AI goal hierarchy.
