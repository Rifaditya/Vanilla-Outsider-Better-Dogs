...
> [!TIP]
> **Want a GUI?** Install the optional **[Cloth Config API](https://modrinth.com/mod/cloth-config)** and **[ModMenu](https://modrinth.com/mod/modmenu)** to get a full categorized settings screen inside the game — no commands needed!
