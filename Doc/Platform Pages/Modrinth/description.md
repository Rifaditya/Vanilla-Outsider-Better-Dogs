...
> [!WARNING]
> **Inbreeding Note**: Inbreeding penalties, outcrossing, and curing systems are only active in the 26.2+ release stream (v4.5.0+). I recommend keeping your breeding lineages clean to avoid stunting your dogs!
