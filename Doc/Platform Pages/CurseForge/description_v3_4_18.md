...
- **Performance Hardened**: All AI logic is performance-optimized using **DasikLibrary 1.7.0**, ensuring zero console spam and server TPS even with massive packs.
...
<blockquote>💡 <strong>Want a GUI?</strong> Install the optional <a href="https://www.curseforge.com/minecraft/mc-mods/cloth-config">Cloth Config API</a> and <a href="https://www.curseforge.com/minecraft/mc-mods/modmenu">ModMenu</a> to get a full categorized settings screen inside the game — no commands needed!</blockquote>
