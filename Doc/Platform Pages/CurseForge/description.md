...
<p align="center">
  <img src="https://raw.githubusercontent.com/Rifaditya/Vanilla-Outsider-Better-Dogs/26.1-core-migration/Doc/Media/Gallery/particles_showcase.png" alt="Personality Particles Showcase" width="85%">
</p>

<p align="center">
  <img src="https://raw.githubusercontent.com/Rifaditya/Vanilla-Outsider-Better-Dogs/26.1-core-migration/Doc/Media/Gallery/particle_aggressive.png" alt="Aggressive dog particle" width="30%">
  <img src="https://raw.githubusercontent.com/Rifaditya/Vanilla-Outsider-Better-Dogs/26.1-core-migration/Doc/Media/Gallery/particle_pacifist.png" alt="Pacifist all love particle" width="30%">
  <img src="https://raw.githubusercontent.com/Rifaditya/Vanilla-Outsider-Better-Dogs/26.1-core-migration/Doc/Media/Gallery/particle_classic.png" alt="Vanilla/Normal" width="30%">
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Rifaditya/Vanilla-Outsider-Better-Dogs/26.1-core-migration/Doc/Media/Gallery/guard_mode_activation.png" alt="Guard Mode Activation" width="48%">
  <img src="https://raw.githubusercontent.com/Rifaditya/Vanilla-Outsider-Better-Dogs/26.1-core-migration/Doc/Media/Gallery/guard_mode_deactivation.png" alt="Guard Mode Deactivation" width="48%">
</p>
...
- **Watchdog Alarms & Buffs**: Pacifist sentinels whine and emit warning note particles when hostiles approach, and optionally apply Regeneration and Resistance to owners/allies if the <code>bd_pacifist_guard_buffs</code> GameRule is enabled.
...
- Spacing increases mathematically based on pack size to prevent visual overcrowding.
- Fully configurable via 4 native GameRules: <code>bd_tamed_pack_spread_multiplier</code>, <code>bd_tamed_pack_spread_max</code>, <code>bd_wild_pack_spread_multiplier</code>, <code>bd_wild_pack_spread_max</code>.
...
- **Debug Tools**: Use <code>/betterdogs debug</code> to test pack interactions and behaviors (Locked behind OP permissions and a safety GameRule).
...
- **GUI Config Integration**: Fully supports configuration GUI integrations via <strong>ModMenu</strong> + <strong>Cloth Config</strong> in singleplayer mode.
  <p align="center">
...
- **Production Stable**: Fully compatible with high-performance engines like <strong>C2ME</strong>, ensuring safe multi-threaded AI execution.
- **Performance Hardened**: All AI logic is performance-optimized using <strong>DasikLibrary</strong>, ensuring zero console spam and smooth server TPS even with massive packs.
